...
# EnclosedPorch: NA most likely means "no porch"
...
numerical_pipeline = Pipeline([('imputer',median_imputer),('min_max_scaler',min_max_scaler)])

column_transformer = ColumnTransformer([("numerical",numerical_pipeline,numerical_features),("categorical",categorical_pipeline,categorical_features)],verbose_feature_names_out=False)
